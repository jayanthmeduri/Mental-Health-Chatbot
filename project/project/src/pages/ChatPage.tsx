...
const handleGenerateReport = async () => {
  try {
    ...
    if (result.status === 'success') {
      // Step 2: Automatically fetch the report file
      const fileResponse = await fetch('http://localhost:5000/latest-report');
      ...
      // Step 3: Get the file blob and create a download link
